...
class ViewSyntaxBuilder extends AbstractSyntaxBuilder
{
    /**
    ...
    {
        return file_get_contents($this->resolveStubPath("/stubs/Resource/views/{$this->viewName}.blade.stub"));
    }
    ...
    private function getElementStub(array $field): string
    {
        ...
        $strSub = $this->files->get($this->resolveStubPath("/stubs/Resource/views/elements/{$element}.blade.stub"));
