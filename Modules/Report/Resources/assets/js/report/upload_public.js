        ...
        function drawChart() {
            $('.chart-item').each(function () {
                ...
                request.done(function (response) {
                    ...
                    dataChart.addRows(data.rows)
                    let LineChart = new google.visualization.ChartWrapper({
                        'chartType': 'LineChart',
                        'containerId': $domChart,
                        'dataTable': dataChart,
                        'options': Object.assign({},{
                            "titleTextStyle":{"fontSize":14},"titlePosition":"out","focusTarget":"category","legend":{"position":"top"},
                            "tooltip":{"textStyle":{"fontName":"Roboto","fontSize":14}},
                            "pointShape":"circle","pointSize":4,"hAxis":{"format":"dd MMM"},
                            "vAxis":{"format":"short"},"lineWidth":2,"chartArea":{"width":"90%","height":"84%","top":"10%","left":"8%"}},
                            {"height":240,"hAxis":{"format":"dd MMM","gridlines":{"count":8}},
                                "vAxis":{"gridlines":{"count":4},"format":"short"},"chartArea":{"width":"90%","height":"83%","top":"7%","left":"8%"},"series":[]},
                            ),
                        'view': {
