...
class PaginationLinks
{
    ...
    public static function create(
        ...
        $numberOfPages,
        $context = 1,
        $linkFormat = '<li><a href="?page=%d" class="item">%d</a></li>',
        $pageFormat = '<li><span class="item">%d</span></li>',
        $ellipsis = '<li>&hellip;</li>')
    {
        $link       = request()->fullUrlWithQuery(['page' => '%d']);
        // $link       = preg_replace('/(123job\.vn|123job\.abc)/', '123job.vn/company', $link);
        $linkFormat = '<li><a href="' . $link . '" class="item">%d</a></li>';
        $linkFormat = urldecode($linkFormat);
