...
CKFinder.define( [ 'underscore', 'backbone', 'marionette', 'doT' ], function( _, Backbone, Marionette, doT ) {
	...
	return {
		init: function( finder ) {
			...
			// Wait for the 'mix:create:Main' event to attach the status bar
			finder.on( 'mix:create:Main', function() {
				// Create a status bar named 'MyStatusBar' for the 'Main' mix which contains the files pane.
