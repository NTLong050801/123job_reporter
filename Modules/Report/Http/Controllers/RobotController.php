...
use Modules\Report\Services\RobotService;
...
class RobotController extends AdminBaseController
{
    ...
    {
        $this->siteService = $managerSiteService;
    ...
    public function index(Request $request) {
        ...
        return view('report::pages.robot.index')->with($viewData);
    }
    ...
    public function getDataForChart(Request $request) {
        ...
        $datas = $this->robotService->getList($site_id);
        $dataTransForm = $this->robotService->getDataForChart($datas,$day);
