...
class RequestCommand extends AbstractCommand
{
     ...
     * @var string
     */
    protected $description = 'Create a request class';
    ...
    public function fire()
    {
        ...
        $this->info("Create Request:" . $path);
        $this->composer->dumpAutoloads();
    }

    public function putRequest($path)
    {
    ...
    {
        $stub = $this->files->get(__DIR__ . "/../../../stubs/Request/NameRequest.stub");
        $this->replaceNamespace($stub)
            ->replaceNameRequest($stub);
    ...
    private function getPath($name, $platform, $package)
    {
        ...
        return $base_path . '/src/Http/Requests/' . $name . '.php';
    }
