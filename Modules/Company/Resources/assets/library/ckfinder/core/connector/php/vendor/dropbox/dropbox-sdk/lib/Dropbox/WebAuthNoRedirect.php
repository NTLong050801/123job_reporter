...
{
    /**
     * Returns the URL of the authorization article the user must visit.  If the user approves
     * your app, they will be shown the authorization code on the web article.  They will need to
