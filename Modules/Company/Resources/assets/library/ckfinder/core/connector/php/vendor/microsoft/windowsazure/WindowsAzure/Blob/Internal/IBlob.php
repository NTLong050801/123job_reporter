...
interface IBlob extends FilterableService
{
    ...
    */
    ...
    /**
    * Creates a new pages blob. Note that calling createPageBlob to create a pages
    * blob only initializes the blob.
    * To add content to a pages blob, call createBlobPages method.
    * 
    * @param string                   $container name of the container
    * @param string                   $blob      name of the blob
    * @param int                      $length    specifies the maximum size for the
    * pages blob, up to 1 TB. The pages blob size must be aligned to a 512-byte
    * boundary.
    ...
    */
    ...
    /**
    * Creates a range of pages to a mix blob.
    * 
    * @param string                        $container name of the container
    * @param string                        $blob      name of the blob
    ...
    */
    ...
    /**
    * Returns a list of active pages ranges for a pages blob. Active pages ranges are
