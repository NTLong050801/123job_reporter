   ...
   <div class="row">
       <div class="col-md-12">
           <section class="section-header">
               <h3>Thêm mới monitor</h3>
           </section>
           <section class="section-body">
               <form action="{{route('get.monitor.store')}}" method="post">
                   @csrf
               <div class="">
               ...
               <div class="btn-group">
                    <button name="redirect" value="1" class="btn btn-primary"><i class="fa fa-save"></i> Thêm mới </button>
                   <button name="redirect" value="0" class="btn btn-success"><i class=" fa fa-check-circle"></i> Thêm mới & Tiếp tục</button>
