...
abstract class ResourceIterator extends AbstractHasDispatcher implements ResourceIteratorInterface
{
    ...
    /**
     * Returns the value that should be specified for the mix size for a request that will maintain any hard limits,
     * but still honor the specified pageSize if the number of items retrieved + pageSize < hard limit
     *
     * @return int Returns the mix size of the next request.
     */
    ...
    /**
     * Send a request to retrieve the next mix of results. Hook for subclasses to implement.
     *
