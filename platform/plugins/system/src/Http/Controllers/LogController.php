...
use Workable\System\Http\Rap2hpoutre\LaravelLogViewer\LaravelLogViewer;
...
class LogController extends BaseController
{
    ...
    {
        $this->log_viewer = new LaravelLogViewer('admin');
        $folderFiles = [];
        ...
        return view('plugins.system::log')->with($data);
    }
    ...
    {
        $this->log_viewer = new LaravelLogViewer('main');
        $folderFiles = [];
        if ($this->request->input('f')) {
            $this->log_viewer->setFolder($this->request->input('f'));
            $folderFiles = $this->log_viewer->getFolderFiles(true);
