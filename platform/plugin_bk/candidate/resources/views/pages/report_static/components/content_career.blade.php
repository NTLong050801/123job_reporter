<h3 style="margin:10px 0 15px 0; font-size: 22px;">Nhóm nghề (tính lũy kế)</h3>
<div class="table-responsive">
    <table class="table table-hover table-bordered table-fixed table-career" id="sort-table">
        <thead class="thead-header">
        <tr class="tr-header" style="display: none">
            <th width="2%">ID</th>
            <th width="150px" style="min-width: 150px;">Ngành nghề</th>
