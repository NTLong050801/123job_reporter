...
interface ResourceIteratorInterface extends ToArrayInterface, HasDispatcherInterface, \Iterator, \Countable
{
     ...
     *
     * The iterator may return more than you specify in the article size argument depending on the service and underlying
     * command implementation.  Set to 0 to specify no article size limitation.
     *
