                    ...
                    <div class="box-body">
                        ...
                        <div class="row-employee data-grid-header clearfix">
                            <div class="button-groups pull-left">
                                <div class="btn-group">
                                    <a id="assign" href="{{ route('get.reference-site.overview') }}" class="btn btn-primary btn-sm">
                                        <i class="fa fa-eye"></i> Xem theo ngày
                                    </a>
                                </div>
                                <div class="btn-group">
                                    <a id="assign" href="{{ route('get.reference-site.month') }}" class="btn btn-default btn-sm">
                                         Xem theo tháng
                                    </a>
                                </div>
                            </div>
                            ...
                            @if ($items['items'])
                                @foreach($items['items'] as $date => $item)
                                    <tr>
                                        ...
                                        <td>{{ $date }}</td>
                                        @foreach($item['visitor'] as $itemVisitor)
                                        ...
                                        @endforeach
                                        @foreach($item['provider'] as $itemVisitor)
                                            <td class="text-center">
                                                <a href="" class="text-primary font-weight-bold">
                                                    <u>{{ $itemVisitor['count'] }}</u> <small class="text-success">(~ {{ $itemVisitor['percent'] }}%)</small>
                                                </a>
                                            </td>
                                        @endforeach
