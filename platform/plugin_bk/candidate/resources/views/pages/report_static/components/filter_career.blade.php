<div class="form-search pull-left fFilterC">
    <form action="{{ route('get.report_static.list_career') }}" method="get" class="form-inline">
        ...
        <div class="form-group">
            ...
            <a href="{{ route('get.report_static.list_career') }}" class="btn btn-default">Làm mới</a>
        </div>
    </form>
</div>
