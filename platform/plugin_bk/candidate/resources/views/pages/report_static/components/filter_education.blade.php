<div class="form-search pull-left fFilterC">
    <form action="{{ route('get.report_static.list_degree') }}" method="get" class="form-inline">
        ...
        <div class="form-group">
            ...
            <a href="{{ route('get.report_static.list_degree') }}" class="btn btn-default">Làm mới</a>
        </div>
    </form>
</div>
