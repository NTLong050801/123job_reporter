...
@section('title', "Danh sách reference")
@section('css')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12" >
                @include('report::pages.components._inc_filter', ['action'=> route('get.reference.index')])
            </div> <!--end filter-->
...
@stop
@section('script')
    <script src="{{ mix('js/reference.js','/vendor/m_report') }}"></script>
    <script>
        var URL_SHOW_REFERENCE ='{{route('get.data.reference')}}';
    </script>
@stop
